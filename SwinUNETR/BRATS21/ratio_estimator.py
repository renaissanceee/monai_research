...
from batchgenerators.utilities.file_and_folder_operations import subfiles, join, save_json, load_json, \
    isfile
import torch
from ratio_utils.ece_utils import calc_ece_kde,calc_bs,calc_v_bias,calc_nll,calc_ece_bins
...
def compute_estimator(reference_file: str, prediction_file: str, probability_file: str,
    ...
    "analyze mean/var"
    # gt
    wt_gt_map, wt_gt_counter = region_or_label_to_mask(seg_ref, (1, 2, 4))
    ...
    if binary:
        ...
        wt_prob_map, _ = region_or_label_to_mask(seg_pred, (1, 2, 4))
